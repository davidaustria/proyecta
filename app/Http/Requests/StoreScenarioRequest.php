...
class StoreScenarioRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'historical_months' => ['required', 'integer', 'min:3', 'max:60'],
            'projection_years' => ['required', 'integer', 'min:1', 'max:10'],
            'status' => ['required', 'string', 'in:draft,active,archived'],
            'is_baseline' => ['boolean'],
            'calculation_method' => ['required', 'string', 'in:simple_average,weighted_average,trend_based'],
