...
import { type BreadcrumbItem, type Projection } from '@/types';
...
export default function ProjectionShow({ projection }: ProjectionShowProps) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head
                title={`Proyección ${projection.year} - ${getDimensionLabel()}`}
            />
